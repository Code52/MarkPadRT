    ...
    public class LayoutAwarePage : Page
    {
        ...
        public void InvalidateVisualState()
        {
            if (_layoutAwareControls != null)
            {
                ...
                {
                    var x = VisualStateManager.GoToState(layoutAwareControl, visualState, false);
                    var g = VisualStateManager.GetVisualStateGroups(layoutAwareControl);
                }
            }
        }
